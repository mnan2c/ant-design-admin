...
import { queryOutStorages } from '@/services/storage/outstorage';
...
const tableColumns = [
  ...
  {
    title: formatMessage({ id: 'auditor' }),
    dataIndex: 'auditor',
  },
  {
    title: formatMessage({ id: 'auditDate' }),
    dataIndex: 'auditDate',
  },
  {
    title: formatMessage({ id: 'auditStatus' }),
